...
catVars <- c("ethnicity", "education", "race", "sex", "bmi", "ahi", "ess", "mmse", "odsi_bl", "adcs_12m")

# Create Table 1
table1 <- CreateTableOne(vars = vars, strata = "adherence", data = Cpap, factorVars = catVars, test = TRUE, addOverall = TRUE)
...
> Participants who were adherent to CPAP treatment had a lower Epworth Sleepiness Scale (ESS) score compared to non-adherent participants (p = 0.02).  
> This shows us that people who used the CPAP regularly reported that they felt less sleepy during the day.
